...
class HostAgent:
    ...
    async def retrieve_card(self, address: str):
        try:
            ...
            print(f"Successfully connected to remote agent at {address}")
        except Exception as e:
            print(f"Failed to connect to remote agent at {address}: {e}")
            # Continue without this agent - the application can still function
    ...
    def register_agent_card(self, card: AgentCard):
        try:
            ...
            print(f"Failed to register agent {card.name}: {e}")
            # Continue without this agent connection
